...
class CDataBase_mysql
{
    ...
    function query($_sql, $_view_sql = false)
    {
        ...
        if (!($this->Resource = mysql_query($_sql,$this->DBLink)))
        {
            if (!$_view_sql)
            {
                user_error("SQL ������: ".$_sql, E_USER_NOTICE);
            }
    ...
    /**
     * Выполняет SELECT запрос и возвращает ресурс результата
     * 
     * @param string table      Имя таблицы или несколько таблиц с JOIN
     * @param string fields     Поля, через запятую, которые нужно вернуть
     * @param string cond       Условие выборки
     * @param string params     Секция для добавления к запросу GROUP, ORDER, LIMIT, HAVING
     * @param bool   viewSql    Вывести получивший SQL запрос
     */
     ...
     * @param string values     Значения через запятую    
     * @param string fields     Имена полей через запятую
     * @param bool   viewSql    Вывести получивший SQL запрос
     */
     ...
     * 
     * @param string table      Имя таблицы
     * @param string cond       Условие для удаления
     * @param bool   viewSql    Вывести получивший SQL запрос
     */
     ...
     * 
     * @param string table      Имя таблицы
     * @param string eqs        Пары поле=значение через запятую
     * @param string cond       Условие для обновления
     * @param bool   viewSql    Вывести получивший SQL запрос
     */
    ...
    /**
     * Выбирает записи поле field которых входит в множество items
     * 
     * @param string table      Имя таблицы или несколько таблиц с JOIN
     * @param string field      Поле, значение которого проверяется на вхождение во множество
     * @param array  items      Множество значений
     * @param string fields     Поля, через запятую, которые нужно вернуть
     * @param string condAnd    Дополнительное условие выборки
     * @param string params     Секция для добавления к запросу GROUP, ORDER, LIMIT, HAVING
     * @param bool   viewSql    Вывести получивший SQL запрос
     */
    ...
    /**
     * Выполняет INSERT запрос для записи (ассоциативный массив)
     * 
     * @param string table      Имя таблицы    
     * @param array  items      Запись, где ключи это имена полей    
     * @param bool   viewSql    Вывести получивший SQL запрос
     */
    ...
    /**
     * Выполняет REPLACE запрос для записи (ассоциативный массив)
     * 
     * @param string table      Имя таблицы    
     * @param array  items      Запись, где ключи это имена полей    
     * @param bool   viewSql    Вывести получивший SQL запрос
    ...
    /**
     * Удаляет записи поле field которых входит в множество items
     * 
     * @param string table      Имя таблицы
     * @param string field      Поле, значение которого проверяется на вхождение во множество
     * @param array  items      Множество значений
    ...
    /**
     * Выполняет UPDATE запрос для записи (ассоциативный массив)
     * 
     * @param string table      Имя таблицы    
     * @param array  items      Запись, где ключи это имена полей    
     * @param string cond       Условие для обновления
    ...
    /**
     * Обновляет записи поле field которых входит в множество items
     * 
     * @param string table      Имя таблицы
     * @param string eqs        Пары поле=значение через запятую
     * @param string field      Поле, значение которого проверяется на вхождение во множество
     ...
     * 
     * @param string table      Имя таблицы
     * @param array  values     Запись, где ключи это имена полей
     * @param string field      Поле, значение которого проверяется на вхождение во множество
     * @param array  items      Множество значений
     * @param string condAnd    Дополнительное условие выборки
     * @param bool   viewSql    Вывести получивший SQL запрос
