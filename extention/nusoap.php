...
class soap_transport_http extends nusoap_base {
    ...
    public $proxyport = '';
        ...
        * @access   public
        */
        function send($data, $timeout=0, $nowait = false) {
...
class soap_server extends nusoap_base {
    ...
    public $operations = array(); // assoc array of operations => opData
        ...
        */
        ...
        $dump = '';
                ...
                // else successfully parsed request into soapval object
                    ...
                    $this->debug('params public dump '.$this->varDump($request_data));
                                if($request_data){
                        ...
                        $this->debug('response public dump'.$this->varDump($method_response));
                                } else {
...
class soapclient extends nusoap_base  {
    ...
    public $xml_encoding = '';
        ...
        * @access   public
        */
        public $fault, $faultcode, $faultstring, $faultdetail;
        ...
        * @access   public
        */
        function call($operation,$params=array(),$namespace='',$soapAction='',$headers=false, $nowait = false){
            ...
            if($namespace == ''){
                ...
                $return = $this->send($soapmsg,$soapAction,$this->timeout,$nowait);
    ...
    *
        ...
        * @access   private
        */
        function send($msg, $soapaction = '', $timeout=0, $nowait = false) {
                // detect transport
                switch(true){
                        // http(s)
                ...
                if($this->username != '' && $this->password != '') {
                                ...
                                //if(strpos($this->endpoint,'http:')){
                                        $response = $http->send($msg,$timeout,$nowait);
        ...
        function getProxy(){
                ...
                foreach($this->operations as $operation => $opData){
                        if($operation != ''){
                                ...
                                $paramStr = '';
                                $paramStr2 = '';
                                if(isset($opData['input']['parts']) && sizeof($opData['input']['parts']) > 0){
                                ...
                                $paramStr2 .= "\$nowait = false";
                                $opData['namespace'] = !isset($opData['namespace']) ? 'http://testuri.com' : $opData['namespace'];
                                $evalStr .= "function $operation ($paramStr2){
                                        // load params into array
                                        \$params = array($paramStr);
                                        return \$this->call('$operation',\$params,'".$opData['namespace']."','".$opData['soapAction']."',\$nowait);
                                }";
                                unset($paramStr);
                        }
                }
