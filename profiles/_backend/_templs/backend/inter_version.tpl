...
<p class="frame_head"><nobr>Версии модуля:</nobr></p>
<div class="clear"></div>
...
<table width="100%">
	<tr>
	    ...
	    <td width="35%"><p style="margin: 0; color: gray">Название:</td>
	    <td width="30%"><p style="margin: 0; color: gray">Псевдоним:</td>
	    <td width="15%"><p style="margin: 0; color: gray">Тип:</td>
	    <td width="15%"><p style="margin: 0; color: gray">Язык:</td>
	</tr>
<tr>
...
<div class="gray_block">
<p class="frame_head"><nobr>Создание версии:</nobr></p>
<div class="clear"></div>
...
<tr>
	...
	<td>
		<select name="add[type]" >
			<option value='0'>Локальная
			<option value='1'>Общая
		</select>
	</td>
</tr>
<tr>
	<td align="right"><p style="margin: 0 4 0 0; color:gray"><nobr><b>Язык:</b></nobr></td>
	<td>
	<!--#list src='languages'-->
