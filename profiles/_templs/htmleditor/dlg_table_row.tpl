...
<form name="td_prop">
<tr>
  <td colspan="2" width="1%"><!--#slot src='horizontal_align'-->:</td>
  <td colspan="2" align="right" nowrap><input type="hidden" name="chalign">
...
<tr>
  <td colspan="2" width="1%"><!--#slot src='vertical_align'-->:</td>
  <td colspan="2" align="right"  nowrap><input type="hidden" name="cvalign">
