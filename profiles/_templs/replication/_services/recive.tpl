...
<table width="90%">
<tr>
        <td width="30%">Разрешить только с хостов (перечислить через ";"):</td>
        <td width="70%"><input name="trans[inhosts]" value="<!--#slot src="inhosts"-->"></td>
</tr>
<tr>
        <td width="30%">Пароль:</td>
        <td width="70%"><input name="trans[inpassword]" value="<!--#slot src="inpassword"-->"></td>
</tr>
<tr>
        <td></td>
